    ...
    try {
      ...
      if (lastPaymentId) {
        ...
        if (lastPaymentId.startsWith("pix_")) {
          ...
          // Tentar buscar na API real - código comentado para evitar CORS
          // Usando dados mock em vez disso
          setPaymentDetails({
            id: lastPaymentId,
            status: "RECEIVED",
            paymentDate: new Date().toISOString(),
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="bg-white shadow-lg rounded-xl overflow-hidden mb-6 border-0">
          <div className="p-4 md:p-8 flex flex-col items-center">
            ...
            <div className="bg-green-50 w-full rounded-lg p-4 md:p-6 mb-6 md:mb-8 flex flex-col items-center">
              <CheckCircle className="text-green-500 h-12 w-12 md:h-16 md:w-16 mb-4" />
              <h1 className="text-xl md:text-3xl font-bold text-green-700 mb-2 text-center">Pagamento Confirmado!</h1>
              <p className="text-green-600 text-center mb-2 text-sm md:text-base">
            ...
            <div className="w-full mb-6 md:mb-8">
              <h2 className="text-lg md:text-xl font-semibold text-gray-800 mb-4">Resumo do Pedido</h2>
              
              <div className="bg-gray-50 rounded-lg p-3 md:p-4 mb-4 md:mb-6">
                <h3 className="font-medium text-base md:text-lg mb-2 md:mb-3">Dados do Cliente</h3>
                <div className="space-y-1 md:space-y-2 text-xs md:text-sm">
                  <div className={`grid ${isMobile ? 'grid-cols-[100px_1fr]' : 'grid-cols-[120px_1fr]'} gap-2`}>
              ...
              {paymentDetails && (
                <div className="bg-blue-50 rounded-lg p-3 md:p-4 mb-4 md:mb-6 border border-blue-100">
                  <h3 className="font-medium text-base md:text-lg text-blue-800 mb-2 md:mb-3">Detalhes do Pagamento</h3>
                  <div className="space-y-1 md:space-y-2 text-xs md:text-sm">
                    <div className={`grid ${isMobile ? 'grid-cols-[100px_1fr]' : 'grid-cols-[120px_1fr]'} gap-2`}>
              ...
              <div className="bg-gray-50 rounded-lg p-3 md:p-4 mb-4 md:mb-6">
                <h3 className="font-medium text-base md:text-lg mb-2 md:mb-3">Pedido</h3>
                <table className="w-full text-xs md:text-sm">
                  ...
                  <tbody>
                    <tr className="border-b border-gray-200">
                      ...
                      <td className="text-center py-2 md:py-3">{clienteData.quantity}</td>
                      <td className="text-right py-2 md:py-3">R$ {clienteData.valorUnitario.toFixed(2)}</td>
                    </tr>
                    <tr>
                      <td colSpan={2} className="text-right py-2 md:py-3 font-bold">Total:</td>
                      <td className="text-right py-2 md:py-3 font-bold text-blue-800">R$ {valorTotal.toFixed(2)}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
