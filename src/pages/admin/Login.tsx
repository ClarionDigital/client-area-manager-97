  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        ...
        navigate("/admin/cartoes-gerados");
      } else {
        toast({
          title: "Erro",
      ...
      <Card className="w-full max-w-md bg-white shadow-lg rounded-xl overflow-hidden border-0">
        <div className="p-6 flex flex-col items-center">
          ...
          <form onSubmit={handleLogin} className="w-full space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Link to="/admin/recuperar-senha" className="text-sm text-[#52aa85] hover:underline">
                  Esqueceu a senha?
                </Link>
              </div>
              <div className="relative">
          ...
          <div className="bg-gray-100 p-4 rounded-lg text-gray-700 text-sm mt-8 w-full shadow-inner">
            <p>
              Sistema de Administração do serviço de solicitação de 2ª via do Kit de Identificação Pessoal. Apenas usuários autorizados podem acessar esse sistema.
            </p>
          </div>
